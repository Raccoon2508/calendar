...
@NgModule({
  ...
  declarations: [EventsListComponent, AddFormComponent, EditEventFormComponent, SingleEventComponent,  DaySheduleComponent,PriorityColorDirective, ColorDirective ],
